...
버전 이력:
  v15 (2026-09-20) — 소샘플 임계값 5→8경기 확장(5=0.80, 6=0.87, 7=0.93 부분 회귀),
                      Cold 패널티 시즌 ERA 연동(ERA<3.5→-4pt, <4.2→-6pt, 이외→-8pt),
                      Hot 보너스 5~7경기 소샘플 감쇠(기존 +3pt→+2pt),
                      팀 승률 격차 계수 강화(±12%↑: 계수 30 신설)
  v14 (2026-09-11) — 소샘플 투수 ERA 보정(결정수 8개 미만 시 신뢰도 상한 제한),
                      시즌 승률 격차 비선형 강화(±6%↑: 계수 20, ±10%↑: 계수 25)
